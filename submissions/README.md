...
- Level 1-5: 3 attempts each.
- Finale Gauntlet: 1 attempt.

Use `docs/submissions/ledger.md` as the source of truth.

Current ready artifacts:

- `level1_duck_curve/attempt1_strategy.py` - best Level 1 candidate, official local score `$859,032.35`.
...
- `level2_frequency_frenzy/attempt2_strategy.py` - OSQP ramp-smoothed Level 2 candidate; local `frequency_frenzy` score `$1,064,526.39` with zero unmet demand.
...
Convenience files at this directory root may exist during development, but target-specific folders are the artifacts to paste into the portal.
